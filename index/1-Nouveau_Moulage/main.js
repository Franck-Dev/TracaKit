...
function scanAction (event){
    ...
    $inputKit.value = '';
    focusTxtArea()
    let divKit = document.getElementById('listKit');
    let texte;
    //texte = tableRes;
    divKit.innerHTML = `Kit : ${texte}`;
    }
}
...
function imprimer_page(elem, OT){
    ...
    var mywindow = window.open("2-PrintableSheet/printSheet.php","Fiche synthèse traçabilité");
